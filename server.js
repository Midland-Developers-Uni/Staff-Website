...
const createStaffTable = require('./DBModel/staff');
const createStaffAccountCreationTokensTable = require('./DBModel/staffAccountCreationTokens');
const createSubjectsTable = require('./DBModel/subjects');
const createStudentsTable = require('./DBModel/students');
const createEventsTable = require('./DBModel/events');
